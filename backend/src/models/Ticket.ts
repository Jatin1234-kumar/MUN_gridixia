...
ticketSchema.index(
  ...
  {
    unique: true,
    name: 'uniq_ticket_registration_active',
    partialFilterExpression: { deletedAt: null },
  },
);
ticketSchema.index(
  { ticketNumber: 1 },
  { unique: true, name: 'uniq_ticket_number_active', partialFilterExpression: { deletedAt: null } },
);
ticketSchema.index(
  { qrToken: 1 },
  {
...
ticketSchema.index(
  ...
  { name: 'ticket_event_status_issued_at_idx' },
);
