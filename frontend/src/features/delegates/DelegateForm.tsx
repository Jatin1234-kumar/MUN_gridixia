...
const applicationSchema = z.object({
  ...
  countryPreference: z.object({
    ...
    reasonForCountry: z
      .string()
      .min(20, 'Explain your preference in at least 20 characters')
      .max(1000),
  }),
  review: z.object({
    termsAccepted: z
...
const stepFields: Record<StepKey, FieldPath<ApplicationFormValues>[]> = {
  ...
  experience: [
    ...
    'experience.previousConferences',
    'experience.awards',
  ],
  committeePreference: [
    'committeePreference.preferredCommitteeId',
    'committeePreference.preferredCommitteeName',
    'committeePreference.secondChoiceCommitteeId',
    'committeePreference.positionPreference',
  ],
  countryPreference: [
    'countryPreference.firstChoiceCountry',
    'countryPreference.secondChoiceCountry',
    'countryPreference.thirdChoiceCountry',
    'countryPreference.reasonForCountry',
  ],
...
>(({ label, error, ...props }, ref) => {
  return (
    <div className="space-y-1.5 sm:col-span-2">
      <Label htmlFor={props.id}>{label}</Label>
      <textarea
        ref={ref} // 👈 Pass the forwarded ref down here
        {...props}
        className={cn(
...
export function DelegateForm() {
  ...
  const selectedCommittee = committees.find(
    (committee: Committee) =>
      committee.id === form.watch('committeePreference.preferredCommitteeId'),
  );
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="space-y-2">
                ...
                <CardTitle className="text-2xl sm:text-3xl">
                  Build your delegate application in seven steps.
                </CardTitle>
                <CardDescription className="max-w-2xl text-sm sm:text-base">
                  Save progress locally, validate each step before moving forward, and resume your
                  application later from the same browser.
                </CardDescription>
              </div>
                        ...
                        >
                            ...
                            >
                              <div className="space-y-1.5">
                                ...
                                <Input
                                  ...
                                  {...form.register('personal.fullName')}
                                  placeholder="Alexandra Chen"
                                />
                                <FieldError
                                  message={form.formState.errors.personal?.fullName?.message}
                                />
                              </div>
                              <div className="space-y-1.5">
                                ...
                                />
                                <FieldError
                                  message={form.formState.errors.personal?.email?.message}
                                />
                              </div>
                              <div className="space-y-1.5">
                                ...
                                <Input
                                  id="personal.phone"
                                  {...form.register('personal.phone')}
                                  placeholder="+1 555 0100"
                                />
                                <FieldError
                                  message={form.formState.errors.personal?.phone?.message}
                                />
                              </div>
                              <div className="space-y-1.5">
                                ...
                                />
                                <FieldError
                                  message={form.formState.errors.personal?.dateOfBirth?.message}
                                />
                              </div>
                              <div className="space-y-1.5 sm:col-span-2">
                                ...
                                <Input
                                  ...
                                  {...form.register('personal.nationality')}
                                  placeholder="Indian"
                                />
                                <FieldError
                                  message={form.formState.errors.personal?.nationality?.message}
                                />
                              </div>
                            </SectionShell>
                          )}
                          ...
                          {key === 'academic' && (
                            <SectionShell
                              ...
                              description="Share your institution and current academic profile."
                              icon={GraduationCap}
                            >
                              <div className="space-y-1.5">
                                ...
                                <Input
                                  ...
                                  {...form.register('academic.institution')}
                                  placeholder="St. Stephen's College"
                                />
                                <FieldError
                                  message={form.formState.errors.academic?.institution?.message}
                                />
                              </div>
                              <div className="space-y-1.5">
                                ...
                                <Input
                                  id="academic.degree"
                                  {...form.register('academic.degree')}
                                  placeholder="Bachelor of Arts"
                                />
                                <FieldError
                                  message={form.formState.errors.academic?.degree?.message}
                                />
                              </div>
                              <div className="space-y-1.5">
                              ...
                              <div className="space-y-1.5">
                                ...
                                <Input
                                  id="academic.major"
                                  {...form.register('academic.major')}
                                  placeholder="Political Science"
                                />
                                <FieldError
                                  message={form.formState.errors.academic?.major?.message}
                                />
                              </div>
                            </SectionShell>
                          )}
                          ...
                          {key === 'experience' && (
                            <SectionShell
                              ...
                              description="Summarize your prior debate and conference experience."
                              icon={NotebookText}
                            >
                              <div className="space-y-1.5">
                                <Label htmlFor="experience.yearsOfExperience">
                                  Experience Level
                                </Label>
                                <SelectField
                              ...
                              <TextareaField
                                id="experience.previousConferences"
                                label="Previous Conferences"
                                placeholder="List conferences, awards, and notable committees you've participated in."
                                error={
                                  form.formState.errors.experience?.previousConferences?.message
                                }
                                {...form.register('experience.previousConferences')}
                              />
                              <TextareaField
                                id="experience.awards"
                                label="Awards or Achievements"
                                placeholder="Optional: note any distinctions, chairs, or best delegate awards."
                                error={form.formState.errors.experience?.awards?.message}
                                {...form.register('experience.awards')}
                              />
                            </SectionShell>
                          )}
                          ...
                          {key === 'committeePreference' && (
                            <SectionShell
                              ...
                              description="Select your first and second choice committee preferences."
                              icon={LayoutList}
                            >
                              <div className="space-y-1.5">
                                <Label htmlFor="committeePreference.preferredCommitteeId">
                                ...
                                <SelectField
                                  ...
                                  {...form.register('committeePreference.preferredCommitteeId')}
                                >
                              ...
                              <div className="space-y-1.5">
                                <Label htmlFor="committeePreference.preferredCommitteeName">
                                  Why this committee?
                                </Label>
                                <Input
                                  id="committeePreference.preferredCommitteeName"
                                  {...form.register('committeePreference.preferredCommitteeName')}
                                  placeholder="Explain your top choice"
                                />
                                <FieldError
                                  message={
                                    form.formState.errors.committeePreference
                                      ?.preferredCommitteeName?.message
                                  }
                                />
                              </div>
                              <div className="space-y-1.5">
                                <Label htmlFor="committeePreference.secondChoiceCommitteeId">
                                ...
                                <SelectField
                                  ...
                                  {...form.register('committeePreference.secondChoiceCommitteeId')}
                                >
                              ...
                              <div className="space-y-1.5">
                                <Label htmlFor="committeePreference.positionPreference">
                                  Position Preference
                                </Label>
                                <Input
                                  id="committeePreference.positionPreference"
                                  {...form.register('committeePreference.positionPreference')}
                                  placeholder="Delegate, chair, or press"
                                />
                                <FieldError
                                  message={
                                    form.formState.errors.committeePreference?.positionPreference
                                      ?.message
                                  }
                                />
                              </div>
                          ...
                          {key === 'countryPreference' && (
                            <SectionShell
                              ...
                              description="Rank your preferred countries and explain the reasoning."
                              icon={MapPin}
                            >
                              <div className="space-y-1.5">
                                <Label htmlFor="countryPreference.firstChoiceCountry">
                                  First Choice
                                </Label>
                                <Input
                                  id="countryPreference.firstChoiceCountry"
                                  {...form.register('countryPreference.firstChoiceCountry')}
                                  placeholder="France"
                                />
                                <FieldError
                                  message={
                                    form.formState.errors.countryPreference?.firstChoiceCountry
                                      ?.message
                                  }
                                />
                              </div>
                              <div className="space-y-1.5">
                                <Label htmlFor="countryPreference.secondChoiceCountry">
                                  Second Choice
                                </Label>
                                <Input
                                  id="countryPreference.secondChoiceCountry"
                                  {...form.register('countryPreference.secondChoiceCountry')}
                                  placeholder="Germany"
                                />
                                <FieldError
                                  message={
                                    form.formState.errors.countryPreference?.secondChoiceCountry
                                      ?.message
                                  }
                                />
                              </div>
                              <div className="space-y-1.5">
                                <Label htmlFor="countryPreference.thirdChoiceCountry">
                                  Third Choice
                                </Label>
                                <Input
                                  id="countryPreference.thirdChoiceCountry"
                                  {...form.register('countryPreference.thirdChoiceCountry')}
                                  placeholder="Japan"
                                />
                                <FieldError
                                  message={
                                    form.formState.errors.countryPreference?.thirdChoiceCountry
                                      ?.message
                                  }
                                />
                              </div>
                              <TextareaField
                                id="countryPreference.reasonForCountry"
                                label="Reason for Country Preference"
                                placeholder="Why do these countries align with your strengths and the committee topic?"
                                error={
                                  form.formState.errors.countryPreference?.reasonForCountry?.message
                                }
                                {...form.register('countryPreference.reasonForCountry')}
                              />
                            </SectionShell>
                          )}
                          ...
                          {key === 'review' && (
                            <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
                              <SectionShell
                                ...
                                description="Check the compiled information before payment."
                                icon={ShieldCheck}
                              >
                                <div className="space-y-2 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 sm:col-span-2">
                                  ...
                                  <div className="grid gap-3 pt-2 sm:grid-cols-2">
                                    <SummaryItem
                                      label="Applicant"
                                      value={form.watch('personal.fullName')}
                                    />
                                    <SummaryItem
                                      label="Email"
                                      value={form.watch('personal.email')}
                                    />
                                    <SummaryItem
                                      label="Committee"
                                      value={
                                    ...
                                    <SummaryItem
                                      ...
                                      value={
                                        selectedEvent
                                          ...
                                          : 'Auto-linked from committee'
                                      }
                                    />
                                    <SummaryItem
                                      label="Country"
                                      value={form.watch('countryPreference.firstChoiceCountry')}
                                    />
                                    <SummaryItem
                                      label="Payment Method"
                                      value={form.watch('payment.paymentMethod').toUpperCase()}
                                    />
                                  </div>
                                </div>
                                ...
                                <div className="space-y-3 sm:col-span-2">
                                  <label className="flex items-start gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4">
                                    <input
                                      ...
                                      {...form.register('review.termsAccepted')}
                                    />
                                    <span>
                                      ...
                                      <span className="block text-xs text-muted-foreground">
                                        You can edit and resave before final submission.
                                      </span>
                                    </span>
                                  </label>
                                  <FieldError
                                    message={form.formState.errors.review?.termsAccepted?.message}
                                  />
                                  <label className="flex items-start gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4">
                                    <input
                                      type="checkbox"
                                      className="mt-1 h-4 w-4 rounded border-white/[0.12] bg-navy-800 text-gold-500 focus:ring-gold-500/50"
                                      {...form.register('review.marketingOptIn')}
                                    />
                                    <span>
                                      <span className="block text-sm font-medium text-foreground">
                                      ...
                                      <span className="block text-xs text-muted-foreground">
                                        Optional product communication only.
                                      </span>
                                    </span>
                                  </label>
                                </div>
                                ...
                                <CardContent className="space-y-3 text-sm text-muted-foreground">
                                  ...
                                  <div className="rounded-xl border border-white/[0.06] bg-navy-900/60 p-4">
                                    ...
                                    <p className="mt-2 text-sm text-foreground">
                                      Your draft stays in this browser until you clear it or submit
                                      a final application.
                                    </p>
                                  </div>
                                </CardContent>
                          ...
                          {key === 'payment' && (
                            <SectionShell
                              ...
                              description="Continue into the dedicated payment experience with recovery support and status tracking."
                              icon={CreditCard}
                            >
                              <div className="sm:col-span-2 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 text-sm text-muted-foreground">
                                <p className="text-foreground">
                                  Your application draft is saved locally. The dedicated payment
                                  page shows the registration summary, fee breakdown, committee
                                  selection, and payment status controls.
                                </p>
                                <p className="mt-2">
                                  Use the link below to continue, or keep editing the draft before
                                  proceeding.
                                </p>
                              </div>
